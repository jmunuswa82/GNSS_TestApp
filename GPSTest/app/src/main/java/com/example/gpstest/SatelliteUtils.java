...
public class SatelliteUtils {
    /**
     * Fetches satellite information using the provided GnssStatus object and updates the satellite table.
     *
     ...
     *                       The method will delegate the task to another class (e.g., SatelliteInfoHelper) to handle
     ...
     *                       The method will delegate the task to another class (e.g., ClearGPS) to handle
